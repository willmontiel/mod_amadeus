...
<div id="amadeus-searcher" ng-app="amadeus" ng-controller="ctrlSearchAmadeus as ctrl" ng-cloak> 
    ...
    <div ng-if="openFilters" class="mt-8">
        <div layout="row" layout-align="start center" class="mb-30">
            <div flex>
        ...
        <div layout="row" layout-align="center center">
            <md-button ng-click="search()" class="md-raised md-primary">Buscar</md-button>
        </div>
    </div>
</div>